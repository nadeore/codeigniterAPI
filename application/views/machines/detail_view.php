                        	...
                        	<?php
                               ...
                               <input type="hidden" name="id" id="id" placeholder="Machine Name" class="form-control" value="<?php if(isset($mdetails)) echo $mdetails->id; ?>">
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Image Upload</label>
                                    <div class="col-sm-10"><input type="file" name="picture" id="picture" class="form-control ">
                                    </div>
                                </div>    
                                
                                <div class="form-group"><label class="col-sm-2 control-label">Invoice Upload</label>
                                    <div class="col-sm-10"><input type="file" name="picture1" id="picture1" class="form-control ">
                                    </div>
                                </div>    
                                
                                <div class="form-group"><label class="col-sm-2 control-label">PDF Upload</label>
                                    <div class="col-sm-10"><input type="file" name="picture2" id="picture" class="form-control ">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2" style="    margin-left: 43.666667%;margin-top: 20px;">
                                        ...
                                        <input type="submit" name="submit" id="submit" value="Save" title="Save changes" class="btn btn-primary" />
                                    </div>
                                </div>
