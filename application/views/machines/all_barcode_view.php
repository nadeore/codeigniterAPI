...
//    return '<img src="http://sa4i.leoinfotech.in/application/views/qrview.php?machineName=" />';
//}
?>
                    ...
                    <div class="machine-list">
                        ...
                        <table class="table table-hover">
                            ...
                            <div class="col-md-2 file-box" style="margin-left: 30px; width: 400px;">
                           	...
                           	<img style="width: 100%;height: 100%;" src="http://sa4i.leoinfotech.in/application/views/<?php echo $machine->bar_code; ?>.gif">
                                        </div>
